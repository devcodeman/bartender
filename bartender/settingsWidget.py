...
class SettingsWidget(QtWidgets.QWidget):
    ...
    def __init__(self, updateSignal:QtCore.Signal):
        super().__init__()
        ...
        '''
        self.view.saveCancelSettingsBox.button(QtWidgets.QDialogButtonBox.StandardButton.Save).clicked.connect(self.saveChanges)
        self.view.saveCancelSettingsBox.button(QtWidgets.QDialogButtonBox.StandardButton.Discard).clicked.connect(self.discardChanges)
